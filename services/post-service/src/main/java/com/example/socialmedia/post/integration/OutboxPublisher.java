package com.example.socialmedia.post.integration;
...
public class OutboxPublisher {
    ...
    @Scheduled(fixedDelayString = "${post.outbox.poll-interval:PT1S}")
    @Transactional
    ...
    @Scheduled(fixedDelayString = "${post.outbox.cleanup-interval:PT1H}", initialDelayString = "PT1M")
    @Transactional
    ...
    private String envelope(OutboxEvent event) throws Exception {
        ...
        envelope.put("producer", "post-service");
